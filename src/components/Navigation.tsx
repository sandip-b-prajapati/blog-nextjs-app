    ...
    <nav className="bg-white shadow-lg">
      ...
      <div className="sm:hidden">
        <div className="pt-2 pb-3 space-y-1">
          ...
          <Link
            href="/auth/login"
            className="block w-full text-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 mx-2"
          >
            Login
          </Link>
        </div>
